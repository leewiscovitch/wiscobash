...
DEV=(tmux jq build-essential python3 python-pip micro ansible starship miniconda)
    ...
    if [ $# -gt 0 ]; then
        case "$1" in
            ...
            --help|-h)
                ...
                echo "  --dev           Install development tools (tmux, jq, build-essential, python3, python-pip, micro, ansible, starship, miniconda)"
